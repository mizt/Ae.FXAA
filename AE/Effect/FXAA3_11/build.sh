...
clang++ -std=c++20 -Wc++20-extensions -bundle -dependency_info -fobjc-arc -O3 -I../../Headers -I../../Util -I./ -framework Cocoa -framework Metal -framework Quartz -framework CoreMedia ./main.mm -o ./${PLUGIN}.plugin/Contents/MacOS/${PLUGIN}
...
cp ./PkgInfo ./${PLUGIN}.plugin/Contents/
